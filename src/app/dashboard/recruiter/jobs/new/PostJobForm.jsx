    ...
    return (
        <div className="min-h-screen bg-[#0d0d0e] text-white py-12 px-4 sm:px-6 lg:px-8">
            <div className="max-w-3xl mx-auto bg-[#121214] border border-zinc-900 rounded-xl p-8 shadow-2xl">
                ...
                {company.status !== "approved" && <div className="bg-amber-500/10 text-amber-400 border-amber-500/20 flex items-center gap-2 p-3 rounded-lg border">
                    
                    <p className="text-sm">Your company profile is not yet approved. Please wait for approval before posting a job.</p>
                </div>}
